...
The following are [node type](hugo).
...
**Derived From:** [cloudify.nodes.Compute](hugo)
...
installations operations-mapping derived from the [built-in cloudify.nodes.Compute type](hugo).
...
**Derived From:** [cloudify.nodes.Root](hugo)
...
**Derived From:** [cloudify.nodes.SecurityGroup](hugo)
...
**Derived From:** [cloudify.nodes.Network](hugo)
...
**Derived From:** [cloudify.nodes.Subnet](hugo)
...
**Derived From:** [cloudify.aws.nodes.Gateway](hugo)
