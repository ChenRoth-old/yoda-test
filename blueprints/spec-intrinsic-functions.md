...
`get_input` is used for referencing `inputs` described in the [inputs](hugo), and node/relationship operation inputs. The function is evaluated on deployment creation.
