...
The following example is taken from the [Upload Resources](hugo) docs page:
...
### Resolving inputs 
Cloudify uses the [Import resolver](hugo) section in the manager blueprint, to create a mapping between URLs.
